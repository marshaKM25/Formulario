...
<body class="d-flex flex-column h-100">
    ...
    <main class="form">
        ...
        <form action="procesar.php" method="post">
            ...
            <!--Añadimos un campo oculto para enviar el form_id al script de validación. -->
            ...
            <div class="mb-3">
                ...
                <input type="text" name="codigo" class="form-control" autocomplete="off" placeholder="Ingresa el texto de la imagen">
            </div>

            <div class="mb-3">
                <!-- Actualizamos la URL de la imagen para que pase el form_id al script de generación. -->
                <img src="funcs/genera_codigo.php?form_id=default" alt="Código de verificación" id="img-codigo">
                &nbsp;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function generaCodigo() {
                // Actualizamos la URL  para que pase el form_id
                // y añadimos un timestamp para evitar problemas de caché del navegador.
                let url = 'funcs/genera_codigo.php?form_id=default&t=' + new Date().getTime();
